...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.CustomViewHolder> {
    private List<Chat> feedItemList;
    private Context mContext;
    private OnItem2ClickListener onItemClickListener;

    public MyRecyclerViewAdapter(Context context, List<Chat> feedItemList) {
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, int i) {
        Chat feedItem = feedItemList.get(i);
        ...
        customViewHolder.textView2.setText(Html.fromHtml(feedItem.getLastmessage()));

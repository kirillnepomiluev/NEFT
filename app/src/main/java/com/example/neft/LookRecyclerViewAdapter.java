...
public class LookRecyclerViewAdapter extends RecyclerView.Adapter<LookRecyclerViewAdapter.CustomViewHolder> {
    private List<User> feedItemList;
    private Context mContext;
    private OnItem2ClickListener onItemClickListener;

    public LookRecyclerViewAdapter(Context context, List<User> feedItemList) {
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, int i) {
        ...
        customViewHolder.textView2.setText(Html.fromHtml((feedItem.isMale())?"муж":"жен"));

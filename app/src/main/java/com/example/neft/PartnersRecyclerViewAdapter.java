...
public class PartnersRecyclerViewAdapter extends RecyclerView.Adapter<PartnersRecyclerViewAdapter.CustomViewHolder> {
    private List<User> feedItemList;
    private Context mContext;
    private OnItem2ClickListener onItemClickListener;

    public PartnersRecyclerViewAdapter(Context context, List<User> feedItemList) {
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, int i) {
        ...
        customViewHolder.textView.setText(Html.fromHtml(feedItem.getLogin()));
        customViewHolder.textView2.setText(Html.fromHtml((feedItem.getStatus())?"Активен":"Неактивен"));
        customViewHolder.textView2.setTextColor(ContextCompat.getColor(mContext,R.color.white));
        customViewHolder.textView2.setBackgroundResource(feedItem.getStatus()? R.color.buttons_recom_color:R.color.colorAccent);
